...
> While most academic projects are pre-fabricated with clean resources and clear direction, this was not. We did this one from scratch! Here is a highlight real
...
* Machine learning algorithms to predict project success
