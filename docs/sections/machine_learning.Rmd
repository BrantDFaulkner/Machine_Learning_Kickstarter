...
> Everyone knows machine learning is all the rage today. But many don't realize when it comes to doing data science, it is often the easiest and least time-consuming part of the project. This project was no exception. Regardless, at the end of it all, we gotta make some predictions. 
...
Both models acheived an aproximately identical accuracy rate in the test sample of 70%. 
...
```{r  echo=FALSE, class.source="overflow"}
summary(tree)
```
