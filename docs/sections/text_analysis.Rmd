...
```{r echo=FALSE, warning=FALSE, message=FALSE}
# Describe topics
labelTopics(poliblogPrevFit, c(1, 7))

cloud(poliblogPrevFit, topic = 1, scale = c(3, 1))
cloud(poliblogPrevFit, topic = 7, scale = c(3, 1))
```
...
```{r echo=FALSE, warning=FALSE, message=FALSE}
# Describe topics
labelTopics(poliblogPrevFit, c(6, 24))

cloud(poliblogPrevFit, topic = 6, scale = c(3, 1))
cloud(poliblogPrevFit, topic = 24, scale = c(3, 1))
```
...
```{r echo=FALSE, warning=FALSE, message=FALSE}
# Describe topics
labelTopics(poliblogPrevFit, c(30, 31, 35, 39))

cloud(poliblogPrevFit, topic = 30, scale = c(3, 1))
cloud(poliblogPrevFit, topic = 31, scale = c(3, 1))
cloud(poliblogPrevFit, topic = 35, scale = c(3, 1))
cloud(poliblogPrevFit, topic = 39, scale = c(3, 1))
```
